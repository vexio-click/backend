...
EXPOSE 3000
CMD bun i; bun run start:dev

# docker build -f Development.Dockerfile -t dev-backend .
# docker run -p 3000:3000 -v C:\Users\Vector\Desktop\AWS\vexio\backend:/backend -v C:\Users\Vector\Desktop\AWS\vexio\frontend\release:/frontend/release dev-backend